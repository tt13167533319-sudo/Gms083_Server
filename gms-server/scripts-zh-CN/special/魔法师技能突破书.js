...
let skillBreakList = [
    ...
    //一转通用
    [2001002, 20, 22, 1, 100, 10],//魔法盾
    [2001005, 20, 22, 1, 100, 10],//魔法双击

    //火毒2转
    [2101001, 20, 22, 2, 90, 30],//精神力
    [2101004, 30, 32, 2, 90, 30],//火焰箭
    //火毒3转
    [2110001, 30, 32, 3, 70, 70],//魔力激化
    [2111002, 30, 32, 3, 70, 70],//末日烈焰
    [2111006, 30, 32, 3, 70, 70],//火毒合击
    //火毒4转
    [2121003, 30, 32, 4, 50, 120],//火凤球
    [2121004, 30, 32, 4, 50, 120],//终极无限
    [2121006, 30, 32, 4, 50, 120],//连环爆破
    [2121007, 30, 32, 4, 50, 120],//天降落星

    //冰雷2转
    [2201001, 20, 22, 2, 90, 30],//精神力
    [2201005, 30, 32, 2, 90, 30],//雷电术
    //冰雷3转
    [2210001, 30, 32, 3, 70, 70],//魔力激化
    [2211002, 30, 32, 3, 70, 70],//冰咆哮
    [2211006, 30, 32, 3, 70, 70],//冰雷合击
    //冰雷4转
    [2221003, 30, 32, 4, 50, 120],//冰凤球
    [2221004, 30, 32, 4, 50, 120],//终极无限
    [2221006, 30, 32, 4, 50, 120],//链环闪电
    [2221007, 30, 32, 4, 50, 120],//落冰霜破

    //牧师
    [2301004, 20, 22, 2, 90, 30],//祝福
    [2301005, 30, 32, 2, 90, 30],//圣箭术
    //祭司
    [2301005, 32, 34, 3, 70, 80],//圣箭术
    [2311003, 30, 32, 3, 70, 70],//神圣祈祷
    [2311004, 30, 32, 3, 70, 70],//圣光
    //主教
    [2321005, 30, 31, 4, 50, 120],//圣灵之盾
    [2321006, 10, 11, 4, 50, 120],//复活术
    [2321004, 30, 32, 4, 50, 120],//终极无限
    [2321007, 30, 32, 4, 50, 120],//光芒飞箭
    [2321008, 30, 32, 4, 50, 120],//圣光普照
