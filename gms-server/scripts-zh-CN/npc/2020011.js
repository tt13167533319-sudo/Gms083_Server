    ...
    if (actionx["Mental"]) {
        ...
        if (sel == 0) {
            ...
            if (cm.getPlayer().getLevel() >= 50) {
                // if (cm.getJobId() >= 411 && cm.getPlayer().getSkillLevel(4201005) == 32) {
                //     if (status == 1) {
                //         cm.sendSimple("#d完成了第三次转职，准备学习更强大的技能了吗？\r\n\r\n#d#L666#升级  #s4201005#   Lv.32 -> Lv.33#l");
                //     } else if (status == 2) {
                //         if (cm.getPlayer().getSkillLevel(4201005) == 32) {
                //             cm.getPlayer().changeSkillLevel(4201005, 33);
                //             cm.sendOk("恭喜你，获得了更强力的技能。");
                //             cm.dispose();
                //         } else {
                //             cm.sendOk("你的技能等级不足哦，请满足条件后再来");
                //             cm.dispose();
                //         }
                //     }
                // } else {
