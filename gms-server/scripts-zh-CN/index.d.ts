...
declare interface Character {
    ...
    buffExpireTask(): void
    breakSkillLevel(SkillId: number, newLevel: number): void
    ...
    changeSkillLevel(SkillId: number, newLevel: number): void
    changeSkillLevel(SkillId: number, newLevel: number, newMasterlevel: number, expiration: number): void
    ...
    getFh(): number
    getFitness(): Fitness
    getFreeSlots(type: number): number
    getFriendshipRings(): []
    getGachaExp(): number
    getGender(): number
    getGuild(): Guild
    ...
    isMarried(): boolean
    isMyJobSkill(skillid: number): boolean
...
declare interface AbstractPlayerInteraction {
    ...
    removeAllByInventory(invType: number): void
    removeAllByInventorySlot(invType: number, slot: number): void
    ...
    setQuestProgress(id: number, infoNumber: number, progress: string): void
    serverMessage(type: number, message: string): void
