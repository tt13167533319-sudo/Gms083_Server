...
values ('server', 'Core', 'java.lang.Short', 'world_count', '2', '开启的大区数量(null)'),
       ('server', 'Core', 'java.lang.Integer', 'max_world_size', '21', '最多允许开启的大区数(max world size)'),
       ...
       ('server', 'Core', 'java.lang.Integer', 'item_limit_on_bossmap', '1000', '独立掉落地图上允许的最大物品数量(Max number of items allowed on a map.)'),
       ...
       ('server', 'Core', 'java.lang.String', 'multi_client_except', '278360404,523509633', '多开特权账号()'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_enforce_job_sp_range', 'true', '改变职业后，根据当前职业计算是否补偿技能点(Caps the player SP level on the total obtainable by their current jobs. After changing jobs, missing SP will be retrieved.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_enable_chat_log', 'true', '日志是否打印玩家聊天信息(Whether print player chat log.)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_map_ownership_system', 'true', '是否开启玩家地图所有权(on/off map ownership system)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'use_map_ownership_system_duration', '60', '玩家地图所有权持续时间，单位：分钟(map ownership system)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_fishing_system', 'true', '是否开启钓鱼系统(on/off fishing system)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_enable_solo_expeditions', 'false', '远征副本任务允许单人进入(Enables start expeditions with any number of players.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_enable_recall_event', 'true', '玩家重连是否继续上次未完成的事件(Enables a disconnected player to reaccess the last event instance they were in before logging out.)'),
       ('server', 'Game Mechanics', 'java.lang.Long', 'respawn_interval', '10000', '怪物刷新间隔，毫秒(mob respawn interval, millisecond)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_login_notification', 'true', '是否开启登录提醒(Send a world notice while player login.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_announce_shop_item_sold', 'true', '当玩家商店或雇佣商店中的物品被售出时，自动向所有者发送消息(Automatic message sent to owner when an item from the Player Shop or Hired Merchant is sold.)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_announce_change_job', 'true', '当职业改变时，自动向熟人发送消息(Automatic message sent to acquantainces when changing jobs.)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_announce_nx_coupon_loot', 'true', '玩家获得点券时是否展示浮动文本(Enables or disables the floating text when a player loots a NX card.)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_announce_global_level_up', 'true', '玩家升级时全服通知，使用命令升级或GM账户除外(Automatic message sent to global when a player level up.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Integer', 'exp_split_level_interval', '20', '组队非攻击玩家必须在怪物N级之内才能获取到怪物经验(Non-contributing players must be within N level between the mob to receive EXP.)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'exp_split_leech_interval', '20', '组队非攻击玩家必须在队友N级之内才能获取到怪物经验(Non-contributing players must be within N level between any contributing party member to receive EXP.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'allow_cash_shop_world_transfer', 'false', '允许玩家在商城购买转区(Allows players to buy world transfers in the cash shop.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Long', 'kite_expire_time', '600000', '风筝横幅预计消失时间，毫秒(Time before kite start disappearing.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Integer', 'quest_point_per_quest_complete', '10', '完成任务获取多少任务点，0为不启用(Each completed quest awards N quest points, set 0 to disable.)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'quest_point_per_event_clear', '20', '完成活动和副本获取多少任务点，0为不启用(Each completed event instance awards N quest points, set 0 to disable.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_equipment_level_up_power', 'true', '装备升级是否增加增加更多属性(Enable more powerful stat upgrades at equip level up.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Integer', 'max_equipment_level_up_stat_up', '3', '装备升一级时能获取的最大属性(Max stat upgrade an equipment can have on a level up.)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'max_equipment_stat', '999', '装备升级的最大属性(Max stat on an equipment by leveling up.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'playernpc_auto_deploy', 'true', '玩家满级后是否自动部署名人堂，否则需要找到转职教官来部署(Makes PlayerNPC automatically deployed on the Hall of Fame at the instant one reaches max level. If false, eligible players must talk to 1st job instructor to deploy a NPC.)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_npcs_scriptable', 'false', '启用服务端预设脚本，否则取客户端本地展示(on/off serverside predefined script NPCs)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Short', 'item_slot_max', '9999', '消耗栏和其他栏的物品最大堆叠，0为默认取wz定义的堆叠数量(Max item slots in Consume and Etc)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Integer', 'trade_limit_meso_under_level', '30', '小于等于该等级的角色每天允许交易的金币将有金额限制，值为-1时则不限制等级(Characters below or equal to this level will have a limit on the amount of coins they can trade per day, while a value of -1 will not limit their level)'),
       ...
       ('server', 'Game Mechanics', 'java.lang.Integer', 'samsara_stele_item', '4009999', '使用轮回碑石需要的道具ID，0为不启用(null)'),
       ('server', 'Game Mechanics', 'java.lang.Byte', 'samsara_stele_item_count', '10', '使用一次轮回碑石需要的道具数量(null)'),
       ('server', 'Game Mechanics', 'java.lang.Byte', 'samsara_stele_duration', '15', '单次轮回持续时间，单位：分钟(null)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'samsara_stele_max', '3', '使用轮回时，每个怪物刷新点的最大怪物刷新数量，BOSS除外(null)'),
       ('server', 'Game Mechanics', 'java.lang.Float', 'samsara_stele_rate', '3.0', '使用轮回时，应用的怪物数量倍率，BOSS除外(null)'),
       ('server', 'Game Mechanics', 'java.lang.Float', 'samsara_stele_rate_special', '0.0', '轮回碑石皮肤应用额外的怪物数量倍率 = samsara_stele_rate + samsara_stele_rate_special(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'samsara_stele_time', '2000', '使用轮回时，应用的怪物刷新频率间隔(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'area_boss_respawn_time', '180', '野外BOSS通用刷新时间，单位（分钟）(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'special_area_boss_respawn_time', '24', '特殊BOSS（鱼王）刷新时间，单位（小时）(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'area_boss_respawn_random_time', '5', '野外BOSS刷新时间随机偏移量，单位：分钟(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'special_area_boss_respawn_random_time', '30', '特殊BOSS（鱼王）刷新时间随机偏移量，单位：分钟(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'area_boss_respawn_broadcast', 'true', '是否开启野外BOSS击杀广播(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'broadcast_skill_book_result', 'true', '是否开启能手册升级广播(null)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'full_screen_attack_damage_limit', '199999', '全屏攻击最高攻击力限制(null)'),
       ('server', 'Game Mechanics', 'java.lang.Byte', 'full_screen_attack_damage_rate_top', '2', '全屏攻击基础攻击系数(null)'),
       ('server', 'Game Mechanics', 'java.lang.Byte', 'full_screen_attack_damage_rate_low', '2', '全屏攻击随机提升系数(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'attack_auto_reduce_hpmp', 'true', '全屏攻击时是否自动掉血掉蓝(null)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'auto_buffs_equip_id', '1032261', '自动BUFF 装备/道具ID(null)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'auto_buffs_check_duration', '5000', '自动BUFF的检测间隔，单位：毫秒(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'solo_drop_map_all', 'false', '是否开启全局独立掉落(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'seen_area_map_drop', 'false', '非独立掉落时，掉落物玩家之间是否可见(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'use_auto_lie_decetor', 'true', '是否开启自动测谎机制(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'auto_lie_decetor_interval', '30', '自动测谎检测时间间隔，单位：分钟(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'fighter_rage_apply_party', 'false', '愤怒之火buff是否应用于队伍其他成员(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'sharp_eyes_apply_party', 'false', '火眼晶晶buff是否应用于队伍其他成员(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'charge_blow_cancel_buff', '29', '圣骑士属性攻击≤n级时则消除属性BUFF,即>n级时不消除属性BUFF(null)'),
       ('server', 'Game Mechanics', 'java.lang.Boolean', 'meso_up_apply_party', 'false', '聚财术/敛财术buff是否应用于队伍其他成员(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'venom_apply_boss', '30', '武器用毒液≤n级时对BOSS不生效，即>n级时对BOSS生效(null)'),
       ('server', 'Game Mechanics', 'java.lang.Integer', 'pick_pocket_special_effect', '0', '敛财术>20级时触发的额外效果技能ID，0为不启用(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'battle_ship_destroy_level', '10', '船长“武装”技能≤n级时会损坏(null)'),
       ('server', 'Game Mechanics', 'java.lang.Short', 'threaten_apply_boss', '20', '压制术≤n级时对BOSS不生效，即>n级时对BOSS生效(null)'),
       ...
       ('server', 'Safe', 'java.lang.Boolean', 'deterred_multi_client', 'true', '是否校验多开(Enables detection of multi-client and suspicious remote IP on the login system.)'),
       ('server', 'Safe', 'java.lang.Integer', 'max_allowed_account_hwid', '2', '一个账号最多允许存在多少台机器上登录，机器一段时间不登录就会失效，不会占用次数(Allows up to N concurrent HWID for an account. HWID remains linked to an account longer the more times it is used to login.)'),
       ...
       ('server', 'Safe', 'java.lang.Boolean', 'use_ip_validation', 'true', '在登录时启用IP检查(Enables IP checking when logging in.)'),
       ...
       ('server', 'Safe', 'java.lang.Boolean', 'use_auto_ban', 'true', '开启自动封禁(on/off auto ban)'),
       ('server', 'Safe', 'java.lang.Boolean', 'use_auto_ban_log', 'true', '开启自动封禁日志(on/off auto ban warning log)'),
       ('server', 'Safe', 'java.lang.Boolean', 'use_exp_gain_log', 'false', '开启经验获取日志(on/off exp gain log)'),
       ('server', 'Safe', 'java.lang.Boolean', 'open_monster_pull_check', 'true', '是否开启吸怪检测(null)'),
       ('server', 'Safe', 'java.lang.Short', 'monster_pull_point_range', '50', '开吸怪检测坐标范围阈值(null)'),
       ('server', 'Safe', 'java.lang.Short', 'monster_pull_point_count', '20', '吸怪检测坐标范围内怪物数量设定(null)'),
       ('server', 'Safe', 'java.lang.Boolean', 'open_mouse_fly_check', '20', '是否开启鼠标飞天检测(null)'),
       ('server', 'Safe', 'java.lang.Integer', 'mouse_fly_check_total', '200000', '鼠标飞天检测总阈值(null)'),
       ('server', 'Safe', 'java.lang.Integer', 'mouse_fly_check_x', '300', '鼠标飞天检测x阈值(null)'),
       ('server', 'Safe', 'java.lang.Integer', 'mouse_fly_check_y', '600', '鼠标飞天检测y阈值(null)'),
       ('server', 'Safe', 'java.lang.Boolean', 'open_pick_item_faraway_check', 'true', '是否开启全屏吸物检测(null)'),
       ('server', 'Safe', 'java.lang.Integer', 'pick_item_faraway_check_total', '150000', '全屏吸物检测总阈值(null)'),
       ('server', 'Safe', 'java.lang.Integer', 'pick_item_faraway_check_x', '400', '全屏吸物检测x阈值(null)'),
       ('server', 'Safe', 'java.lang.Integer', 'pick_item_faraway_check_y', '600', '全屏吸物检测y阈值(null)'),
       ...
       ('server', 'Debug', 'java.lang.Boolean', 'use_debug', 'true', '将在客户端上启用一些面向调试的文本打印(Will enable some text prints on the client, oriented for debugging purposes.)'),
       ...
       ('server', 'Debug', 'java.lang.Boolean', 'open_login_error_log', 'true', '是否记录登录失败日志(null)'),
       ('server', 'Debug', 'java.lang.Boolean', 'use_debug_buff_skill', 'false', '客户端打印技能buff类信息，StatEffect.applyto(null)'),
       ('server', 'Debug', 'java.lang.Boolean', 'use_debug_damage_max', 'false', '客户端打印伤害预估数值(null)'),
       ...
       ('server', 'GM', 'java.lang.Boolean', 'use_perfect_gm_scroll', 'false', 'GM砸卷不消耗次数，必成功(Scrolls from GMs never uses up slots nor fails.)'),
       ...
       ('server', 'GM', 'java.lang.Boolean', 'use_auto_hide_gm', 'false', 'gm登录自动隐身(GMs are automatically hidden when joining)'),
       ('server', 'GM', 'java.lang.Boolean', 'cooldown_zero_gm', 'true', 'GM使用技能时CD是否为0(null)'),

       ('world', '0', 'java.lang.Integer', 'flag', '3', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ('world', '0', 'java.lang.String', 'server_message', 'null!', '顶部滚动信息(top scrolling information)'),
       ('world', '0', 'java.lang.String', 'event_message', '欢迎来到童心大家庭!', '大区描述(world description)'),
       ('world', '0', 'java.lang.String', 'recommend_message', '欢迎来到童心大家庭!', '大区推荐信息(world recommend information)'),
       ('world', '0', 'java.lang.Integer', 'channel_size', '6', '启动频道数(default channel size)'),
       ...
       ('world', '0', 'java.lang.Float', 'quest_rate', '2.0', '任务倍率(quest rate)'),
       ...
       ('world', '0', 'java.lang.Short', 'world_level', '50', '世界等级，0为不启用(null)'),
       ('world', '0', 'java.lang.Boolean', 'only_allow_gm_login', 'false', '是否仅允许GM登录(only_allow_gm_login)'),

       ('world', '1', 'java.lang.Integer', 'flag', '3', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ('world', '1', 'java.lang.String', 'server_message', '欢迎来到童心大家庭!', '顶部滚动信息(top scrolling information)'),
       ('world', '1', 'java.lang.String', 'event_message', '欢迎来到童心大家庭!', '大区描述(world description)'),
       ('world', '1', 'java.lang.String', 'recommend_message', '欢迎来到童心大家庭!', '大区推荐信息(world recommend information)'),
       ('world', '1', 'java.lang.Integer', 'channel_size', '10', '启动频道数(default channel size)'),
       ('world', '1', 'java.lang.Float', 'exp_rate', '1.0', '经验倍率(exp rate)'),
       ('world', '1', 'java.lang.Float', 'meso_rate', '1.0', '金币倍率(meso rate)'),
       ('world', '1', 'java.lang.Float', 'drop_rate', '1.0', '掉落倍率(drop rate)'),
       ('world', '1', 'java.lang.Float', 'boss_drop_rate', '1.0', 'BOSS掉落倍率(boss drop rate)'),
       ('world', '1', 'java.lang.Float', 'quest_rate', '1.0', '任务倍率(quest rate)'),
       ('world', '1', 'java.lang.Float', 'fishing_rate', '1.0', '钓鱼倍率(fishing rate)'),
       ('world', '1', 'java.lang.Float', 'travel_rate', '1.0', '旅行倍率(travel rate)'),
       ('world', '1', 'java.lang.Float', 'level_exp_rate', '0', '等级经验倍率，0为不启用(extra level exp rate, 0 is disabled)'),
       ('world', '1', 'java.lang.Integer', 'quick_level', '0', '冲刺等级，0为不启用(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '1', 'java.lang.Float', 'quick_level_rate', '0', '冲刺等级倍率(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '1', 'java.lang.Short', 'world_level', '50', '世界等级，0为不启用(null)'),
       ('world', '1', 'java.lang.Boolean', 'only_allow_gm_login', 'false', '是否仅允许GM登录(only_allow_gm_login)'),

       ('world', '2', 'java.lang.Integer', 'flag', '3', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ('world', '2', 'java.lang.String', 'server_message', '欢迎来到童心大家庭!', '顶部滚动信息(top scrolling information)'),
       ('world', '2', 'java.lang.String', 'event_message', '欢迎来到童心大家庭!', '大区描述(world description)'),
       ('world', '2', 'java.lang.String', 'recommend_message', '欢迎来到童心大家庭!', '大区推荐信息(world recommend information)'),
       ('world', '2', 'java.lang.Integer', 'channel_size', '10', '启动频道数(default channel size)'),
       ('world', '2', 'java.lang.Float', 'exp_rate', '1.0', '经验倍率(exp rate)'),
       ('world', '2', 'java.lang.Float', 'meso_rate', '1.0', '金币倍率(meso rate)'),
       ('world', '2', 'java.lang.Float', 'drop_rate', '1.0', '掉落倍率(drop rate)'),
       ('world', '2', 'java.lang.Float', 'boss_drop_rate', '1.0', 'BOSS掉落倍率(boss drop rate)'),
       ('world', '2', 'java.lang.Float', 'quest_rate', '1.0', '任务倍率(quest rate)'),
       ('world', '2', 'java.lang.Float', 'fishing_rate', '1.0', '钓鱼倍率(fishing rate)'),
       ('world', '2', 'java.lang.Float', 'travel_rate', '1.0', '旅行倍率(travel rate)'),
       ('world', '2', 'java.lang.Float', 'level_exp_rate', '0', '等级经验倍率，0为不启用(extra level exp rate, 0 is disabled)'),
       ('world', '2', 'java.lang.Integer', 'quick_level', '0', '冲刺等级，0为不启用(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '2', 'java.lang.Float', 'quick_level_rate', '0', '冲刺等级倍率(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '2', 'java.lang.Short', 'world_level', '50', '世界等级，0为不启用(null)'),
       ('world', '2', 'java.lang.Boolean', 'only_allow_gm_login', 'false', '是否仅允许GM登录(only_allow_gm_login)'),

       ('world', '3', 'java.lang.Integer', 'flag', '3', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ('world', '3', 'java.lang.String', 'server_message', '欢迎来到童心大家庭!', '顶部滚动信息(top scrolling information)'),
       ('world', '3', 'java.lang.String', 'event_message', '欢迎来到童心大家庭!', '大区描述(world description)'),
       ('world', '3', 'java.lang.String', 'recommend_message', '欢迎来到童心大家庭!', '大区推荐信息(world recommend information)'),
       ('world', '3', 'java.lang.Integer', 'channel_size', '10', '启动频道数(default channel size)'),
       ('world', '3', 'java.lang.Float', 'exp_rate', '1.0', '经验倍率(exp rate)'),
       ('world', '3', 'java.lang.Float', 'meso_rate', '1.0', '金币倍率(meso rate)'),
       ('world', '3', 'java.lang.Float', 'drop_rate', '1.0', '掉落倍率(drop rate)'),
       ('world', '3', 'java.lang.Float', 'boss_drop_rate', '1.0', 'BOSS掉落倍率(boss drop rate)'),
       ('world', '3', 'java.lang.Float', 'quest_rate', '1.0', '任务倍率(quest rate)'),
       ('world', '3', 'java.lang.Float', 'fishing_rate', '1.0', '钓鱼倍率(fishing rate)'),
       ('world', '3', 'java.lang.Float', 'travel_rate', '1.0', '旅行倍率(travel rate)'),
       ('world', '3', 'java.lang.Float', 'level_exp_rate', '0', '等级经验倍率，0为不启用(extra level exp rate, 0 is disabled)'),
       ('world', '3', 'java.lang.Integer', 'quick_level', '0', '冲刺等级，0为不启用(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '3', 'java.lang.Float', 'quick_level_rate', '0', '冲刺等级倍率(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '3', 'java.lang.Short', 'world_level', '50', '世界等级，0为不启用(null)'),
       ('world', '3', 'java.lang.Boolean', 'only_allow_gm_login', 'false', '是否仅允许GM登录(only_allow_gm_login)'),

       ('world', '4', 'java.lang.Integer', 'flag', '3', '0=普通大区，1=活动大区，2=新区，3=热门大区(0=nothing,1=event,2=new,3=hot)'),
       ('world', '4', 'java.lang.String', 'server_message', '欢迎来到童心大家庭!', '顶部滚动信息(top scrolling information)'),
       ('world', '4', 'java.lang.String', 'event_message', '欢迎来到童心大家庭!', '大区描述(world description)'),
       ('world', '4', 'java.lang.String', 'recommend_message', '欢迎来到童心大家庭!', '大区推荐信息(world recommend information)'),
       ('world', '4', 'java.lang.Integer', 'channel_size', '10', '启动频道数(default channel size)'),
       ('world', '4', 'java.lang.Float', 'exp_rate', '1.0', '经验倍率(exp rate)'),
       ('world', '4', 'java.lang.Float', 'meso_rate', '1.0', '金币倍率(meso rate)'),
       ('world', '4', 'java.lang.Float', 'drop_rate', '1.0', '掉落倍率(drop rate)'),
       ('world', '4', 'java.lang.Float', 'boss_drop_rate', '1.0', 'BOSS掉落倍率(boss drop rate)'),
       ('world', '4', 'java.lang.Float', 'quest_rate', '1.0', '任务倍率(quest rate)'),
       ('world', '4', 'java.lang.Float', 'fishing_rate', '1.0', '钓鱼倍率(fishing rate)'),
       ('world', '4', 'java.lang.Float', 'travel_rate', '1.0', '旅行倍率(travel rate)'),
       ('world', '4', 'java.lang.Float', 'level_exp_rate', '0', '等级经验倍率，0为不启用(extra level exp rate, 0 is disabled)'),
       ('world', '4', 'java.lang.Integer', 'quick_level', '0', '冲刺等级，0为不启用(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '4', 'java.lang.Float', 'quick_level_rate', '0', '冲刺等级倍率(Gain bonus experience for levels below the target, and receive reduced experience for levels at or above the target.)'),
       ('world', '4', 'java.lang.Short', 'world_level', '50', '世界等级，0为不启用(null)'),
       ('world', '4', 'java.lang.Boolean', 'only_allow_gm_login', 'false', '是否仅允许GM登录(only_allow_gm_login)'),