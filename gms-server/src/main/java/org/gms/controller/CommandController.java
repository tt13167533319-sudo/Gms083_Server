...
public class CommandController {
    ...
    //重装商城
    @Tag(name = "/command/" + ApiConstant.LATEST)
    @Operation(summary = "复用GM命令代码进行重装商城")
    @GetMapping("/" + ApiConstant.LATEST + "/reloadCashShopByGMCommand")
    public ResultBody reloadCashShopByGMCommand() {
        commandService.reloadCashShopByGMCommand();
        return ResultBody.success();
    }
}