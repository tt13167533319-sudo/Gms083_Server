...
//    public static String[] WORLD_NAMES = {"Scania", "Bera", "Broa", "Windia", "Khaini", "Bellocan", "Mardia", "Kradia", "Yellonde", "Demethos", "Galicia", "El Nido", "Zenith", "Arcenia", "Kastia", "Judis", "Plana", "Kalluna", "Stius", "Croa", "Medere"};
    public static String[] WORLD_NAMES = {"蓝蜗牛", "蘑菇仔", "绿水灵", "漂漂猪", "小青蛇", "红螃蟹", "大海龟", "章鱼怪", "顽皮猴", "星精灵", "胖企鹅", "白雪人", "石头人", "紫色猫", "大灰狼", "小白兔", "喷火龙", "火野猪", "青鳄鱼", "花蘑菇", "牛魔王"};
    ...
    public static int isTamingMobChair(int ItemId) {
        switch (ItemId) {
            case 3015564: // 太阳椅子
                return 1933256;
            case 3015570: // 土星椅子
