        ...
        if ("world".equals(gameConfigDO.getConfigType())) {
            ...
            switch (gameConfigDO.getConfigCode()) {
                ...
                case "flag":
                    ...
                    break;
                case "world_level":
                    short worldLevel = Short.parseShort(gameConfigDO.getConfigValue());
                    world.setWorld_level(worldLevel);
                    break;
                case "only_allow_gm_login":
                    boolean onlyAllowGMLogin = Boolean.parseBoolean(gameConfigDO.getConfigValue());
                    world.setOnly_allow_gm_login(onlyAllowGMLogin);
                    break;
            }
        }
        // 重载其余部分
