...
public class DataTool {
    ...
    public static int getInt(Data data) {
        ...
        return switch (obj) {
            ...
            // 处理Short类型（解决ClassCastException的核心）
            case Short i -> i.intValue(); // Short转int

            // 不支持的类型：抛出异常明确错误原因，方便调试
            case null, default -> throw new IllegalArgumentException(
                    "Unsupported data type for getInt: " + obj.getClass().getSimpleName() +
                            ", value: " + obj
            );
        };
