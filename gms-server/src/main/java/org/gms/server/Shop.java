...
public class Shop {
    ...
    static {
        ...
        rechargeableItems.add(ItemId.BLAZE_CAPSULE);//红魔方
        rechargeableItems.add(ItemId.GLAZE_CAPSULE);//蓝魔方
        rechargeableItems.add(ItemId.BALANCED_FURY);//平衡之怒
//        rechargeableItems.add(ItemId.High_Tech_Electro_Light_Throwing_Star);//高科技电光标
//        rechargeableItems.add(ItemId.Flame_Throwing_Star);//火焰飞镖
//        rechargeableItems.add(ItemId.Infinite_Throwing_Star);//无限飞镖
//        rechargeableItems.add(ItemId.Platinum_Throwing_Star);//白金飞镖
