...
public class AbstractPlayerInteraction {
    ...
    public void openNpc(String script) {
        openNpc(0, script);
    }
    ...
    public boolean isItemExist(int itemId) {
        return getItemName(itemId) != null && ItemInformationProvider.getInstance().getEquipStats(itemId) != null;
    }
    ...
    public Item makeItemWithId(int itemid) {
        ...
        else return new Item(itemid, (short) 1, (short) 1);
    }

    public void itemMessage(String message, Item item) {
        Server.getInstance().broadcastMessage(getPlayer().getWorld(), PacketCreator.itemMegaphone(message, false, c.getChannel(), item));
    }

    public void serverMessage(int type, String message) {
        Server.getInstance().broadcastMessage(getPlayer().getWorld(), PacketCreator.serverNotice(type, 0, message, false));
    }
    ...
    public void dropMessage(int type, int message) {
        getPlayer().dropMessage(type, String.valueOf(message));
    }
    ...
    public String getSkillName(int skillId) {
        return SkillFactory.getSkill(skillId).getName();
    }
